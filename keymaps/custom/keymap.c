...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,      KC_COMM, KC_DOT,  KC_SLSH, KC_RO,    KC_RSFT, JP_AMARK, \
    MO(1),   KC_LALT, KC_LGUI,    KC_LANG2,      KC_SPC,    KC_SPC,  KC_LANG1,  KC_RGUI,                   KC_LEFT,  KC_DOWN, KC_RIGHT  \
  ),
  [1] = LAYOUT( \
    _______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,     KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,  KC_F12,    KC_DEL, \
    RGB_TOG, RGBRST,  RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX,   XXXXXXX, KC_PGUP, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   \
